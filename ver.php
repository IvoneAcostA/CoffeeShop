    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <!-- Enlace para descargar la lista de proveedores en formato Excel -->
                <a href="/o/php/informe/export_excel.php" class="btn btn-default">Descargar lista proveedores</a>
            </div>
        </div>
    </div>
